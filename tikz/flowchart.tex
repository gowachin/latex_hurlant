...
\node[block,minimum width=6em](Ceit){$C_{e,i,t}$};

\node[block,minimum width=6em](wCei){$wC_{e,i}$};



\node[block,minimum width=6em](Yeit){$Y_{e,i,t}$};

\node[block,minimum width=6em](Cefmit){$C_{e,f,m,i,t}$};

\node[block,minimum width=6em](wDei){$wD_{e,i}$};

 \node[block,minimum width=6em](Defmit){$D_{e,f,m,i,t}$};
 \node[below= 2em of Defmit,block,minimum width=6em](Yefmit){$Y_{e,f,m,i,t}$};


 \node[right=4em of Defmit,block,minimum width=6em](Lefmit){$L_{e,f,m,i,t}$};
 \draw[->,thick](Defmit.east) to[bend left] (Lefmit.west);
 \draw[->,thick](Yefmit.east) to[bend left] (Lefmit.west);
\end{tikzpicture}
