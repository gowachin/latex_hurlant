...
\begin{tikzpicture}
    ...
    \node at (0,0) (forest) {};
    \draw [rounded corners] (forest) rectangle +(14.2, -16.4) {};
    \node [below right=\r cm and \r cm of forest] { \textbf{Forest class} (community/plot)};

    \node at (\r, -1.2) (species) {};
    \draw [rounded corners, dotted] (species)rectangle +(13.8, -13.8) {};

    \begin{scope}[xshift = 2*\r cm, yshift = -1.4 cm]

    \node at (0, 0) (speciesB) {};
    % \draw [rounded corners] (speciesB)rectangle +(13.4, -13.2) {};
    \draw [rounded corners] (speciesB) -- (4,0) -- (4,-1) -- (13.4,-1) -- (13.4, -13.4) -- (0, -13.4) -- (0, -0.2) -- cycle;
    \node [below right=\r cm and \r cm of speciesB] {\textbf{Species class}};

    \node at (4.2, 0) (sp1) {};           \node at (4.2 + 3.2, 0) (sp2) {}; 

    \draw [rounded corners] (sp1) rectangle node{Species A} +(3, -0.8);
    \draw [rounded corners] (sp2) rectangle node{Species B} +(3, -0.8);
